...
class _MnistLoader():
    ...
    def loader(self):
        return _Dataset2D(28, 28, 1, 10, self)


class _Dataset2D():
    def __init__(self, width, height, channels, target, loader):
...
def load_mnist():
    return _MnistLoader('/data/mnist').loader()

def load_fashion_mnist():
    return _MnistLoader('/data/fashion-mnist').loader()
